...
import com.alphadevs.wikunum.services.config.KafkaSseConsumer;
import com.alphadevs.wikunum.services.config.KafkaSseProducer;
...
@RestController
@RequestMapping("/api/payment-management-kafka")
public class PaymentManagementKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PaymentManagementKafkaResource.class);
    ...
    public PaymentManagementKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
